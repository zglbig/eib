package org.zgl.game.socket.http;
    ...
    public static <T> T createProxy(final Class serviceInterFace, final List<Long> uids) {
        return (T) Proxy.newProxyInstance(serviceInterFace.getClassLoader(), new Class<?>[]{serviceInterFace}, new InvocationHandler() {
            ...
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                ...
                GateIoMessage gateIoMessage = new GateIoMessage(MutualEnum.SERVER_TO_CLIENT.id(),ConfigFactory.getInstance().getSocketUrlCfg().getGame1Id(),ProtostuffUtils.serializer(response));
    ...
    public static <T> T createNotifyAllProxy(final Class serviceInterFace){
        return (T) Proxy.newProxyInstance(serviceInterFace.getClassLoader(), new Class<?>[]{serviceInterFace}, new InvocationHandler() {
            ...
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                ...
                GateIoMessage gateIoMessage = new GateIoMessage(MutualEnum.SERVER_TO_CLIENT_NOTIFY_ALL.id(),ConfigFactory.getInstance().getSocketUrlCfg().getGame1Id(),ProtostuffUtils.serializer(response));
                GameServer.getInstance().write(gateIoMessage);
                return null;
            }
        });
    ...
    public static <T> T createTaskProxy(final Class serviceInterFace){
        return (T) Proxy.newProxyInstance(serviceInterFace.getClassLoader(), new Class<?>[]{serviceInterFace}, new InvocationHandler() {
            ...
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                ...
                String argsTemp = JsonUtils.jsonSerialize(args);
                ResponseIoMessage response = new ResponseIoMessage(null,interfaceName,methodName,argsTemp);
                GateIoMessage gateIoMessage = new GateIoMessage(MutualEnum.SERVER_TO_CLIENT_TASK.id(),ConfigFactory.getInstance().getSocketUrlCfg().getGame1Id(),ProtostuffUtils.serializer(response));
                GameServer.getInstance().write(gateIoMessage);
                return null;
            }
        });
