package org.zgl.game.socket.tcp;
...
import org.zgl.game.socket.tcp.channel.GameSimpleChannelInboundHandler;
import org.zgl.game.socket.tcp.code.GameByteToMessageDecoder;
import org.zgl.game.socket.tcp.code.GameMessageToByteEncoder;
...
public final class GameServer {
    ...
    private final GateIoMessage getRegistMessage(){
        ...
        list.add(socketUrlCfg.getGame1Id());
