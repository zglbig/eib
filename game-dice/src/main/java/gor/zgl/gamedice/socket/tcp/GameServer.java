package gor.zgl.gamedice.socket.tcp;
...
import org.zgl.gamedice.socket.tcp.channel.GameSimpleChannelInboundHandler;
import org.zgl.gamedice.socket.tcp.code.GameByteToMessageDecoder;
import org.zgl.gamedice.socket.tcp.code.GameMessageToByteEncoder;
...
public final class GameServer {
    ...
    private final GateIoMessage getRegistMessage(){
        ...
        gateIoMessage.setGameId(socketUrlCfg.getGameDiceId());
        ClientTcpIoMessage clientRequsetIoMessage = new ClientTcpIoMessage();
        List<Object> list = new ArrayList<>();
        list.add(socketUrlCfg.getGameDiceId());
