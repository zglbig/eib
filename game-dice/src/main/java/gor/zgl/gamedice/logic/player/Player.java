package gor.zgl.gamedice.logic.player;

import gor.zgl.gamedice.logic.room.Room;
...
public class Player {
    ...
    /**当局下注金额*/
    private long nowBetCount;
    private Room room;
    public Player(GameDiceServerPlayerDto playerDto) {
    ...
    public long getNowBetCount() {
        return nowBetCount;
    }

    public void setNowBetCount(long nowBetCount) {
        this.nowBetCount = nowBetCount;
    }
    public void insertNowBetCount(long count){
        this.nowBetCount += count;
    }
    public void clearNowBetCount(){
        this.nowBetCount = 0;
    }
