...
//        ExcelUtils.init("excel");
        ...
        builder.scanAnnotation("org.zgl",ConfigFactory.getInstance().getSocketUrlCfg().getGameLotteryId(),"E://GameGroup//framework//cs//proxy//lottery");
    }
}
