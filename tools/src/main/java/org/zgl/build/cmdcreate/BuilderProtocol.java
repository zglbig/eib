package org.zgl.build.cmdcreate;


import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.zgl.build.common.BuilderAll;
import org.zgl.build.common.CheckType;
import org.zgl.build.common.CodeModel;
import org.zgl.build.desc.Protocol;
...
public class BuilderProtocol {
    private static final Logger logger = LoggerFactory.getLogger(BuilderProtocol.class);
    /**
     * 获取拥有Service注解的所有类
     * @param path 包路径
     * @return
    ...
    private static void checkId(List<ProtocolPackage> protocolModules){
        ...
        while (iterator.hasNext()){
            ...
            if(ids.contains(cazzId)){
                logger.error("注解为"+cazzId+"的id值重复请重新设值，其中一个类名为："+module.getClazzName());
