package org.zgl.hall.socket.tcp;
...
import org.zgl.hall.socket.tcp.channel.GameSimpleChannelInboundHandler;
import org.zgl.hall.socket.tcp.code.GameByteToMessageDecoder;
import org.zgl.hall.socket.tcp.code.GameMessageToByteEncoder;
...
public final class GameServer {
    ...
    private final GateIoMessage getRegistMessage() {
        ...
        gateIoMessage.setGameId(socketUrlCfg.getHallId());
        ClientTcpIoMessage clientRequsetIoMessage = new ClientTcpIoMessage();
        List<Object> list = new ArrayList<>();
        list.add(socketUrlCfg.getHallId());
