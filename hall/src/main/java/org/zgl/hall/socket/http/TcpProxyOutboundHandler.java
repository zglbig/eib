package org.zgl.hall.socket.http;
    ...
    public static <T> T createProxy(final Class serviceInterFace, final List<Long> uids) {
        return (T) Proxy.newProxyInstance(serviceInterFace.getClassLoader(), new Class<?>[]{serviceInterFace}, new InvocationHandler() {
            ...
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                ...
                GateIoMessage gateIoMessage = new GateIoMessage(MutualEnum.SERVER_TO_CLIENT.id(), ConfigFactory.getInstance().getSocketUrlCfg().getHallId(), ProtostuffUtils.serializer(response));
